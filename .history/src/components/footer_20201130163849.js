            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="footer-text">
                        ...
                        <ul>
                            {props.wordpressWpApiMenusMenusItems.items.map(itemmenu => (
                                <li key={itemmenu.object_slug} >
                                    <Link to={`/${itemmenu.object_slug}`}>
                                    {itemmenu.title}
                                    </Link>
                                </li>
                            ))}
                        ...
                        <div className="copyright-text">
                            <p dangerouslySetInnerHTML={{__html: item.node.options.footer_copyright}} />
