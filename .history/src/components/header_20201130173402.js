...
import '../assets/allcss/custom.css'
import '../assets/allcss/global.css'
import '../assets/allcss/bootstrap.min.css'
import '../assets/allcss/font-awesome.min.css'
import '../assets/allcss/slicknav.min.css'
import '../assets/allcss/elegant-icons.css'
        ...
        <div className="container">
            ...
            <div className="nav-menu">
                <nav className="mainmenu mobile-menu">
                    <ul>
                    {data.wordpressWpApiMenusMenusItems.items.map(item => (
                      <li activeClassName='active' key={item.path} >
                ...
                <Link to="/contact" className="primary-btn top-btn"><i className="fa fa-ticket"></i> Get A Quote</Link>
            </div>
