...
const Homebanner = () => (
  <StaticQuery
    ...
    render={props => (
      <>
        <section className="hero-section set-bg" style={{backgroundImage:props.data.allWordpressPage.edges.node.home_background_image.localFile.childImageSharp.fluid}}>
