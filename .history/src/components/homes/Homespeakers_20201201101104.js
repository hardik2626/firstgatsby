...
const Homespeakers = () => (
  ...
  <StaticQuery
    ...
    {props.allWordpressWpSpeaker.edges.map(speakii => (
    <div className="member-item set-bg" style={{backgroundImage: `url(${speakii.node.featured_media.localFile.url})`}}>
        <div className="mi-social">
            <div className="mi-social-inner bg-gradient">
                <a href={speakii.node.acf.speaker_facebook}><i className="fa fa-facebook"></i></a>
