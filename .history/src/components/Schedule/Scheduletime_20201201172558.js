            ...
            <div className="col-lg-12">
                <div className="schedule-table-tab">
                    ...
                    {props.allWordpressWpSchedule.edges.map(itemmenu => (
                        ...
                        <li className="nav-item" key={itemmenu.categories.slug}>
                            <Link to={`/${itemmenu.categories.slug}`} className="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">{itemmenu.categories.name}</Link>
                        </li>
                            ))}
                        ...
                        <div className="tab-pane active" id="tabs-1" role="tabpanel">
                            <div className="schedule-table-content">
                                <table>
                                    ...
                                    <tbody>
                                    {props.allWordpressWpSchedule.event_schedule.map(ddd => (
                                        <tr>
                                            <td className="event-time">{ddd.schedule_time}</td>
                                            <td className="break hover-bg">
                                                <h5>{ddd.schedule_title}</h5>
                                            </td>
                                        </tr>
                                        ))}
                                        {/* <tr>
