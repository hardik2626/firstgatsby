                            ...
                            <div className="schedule-table-content">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        {/* <tr>
                                            <td class="event-time">{items.node.acf.marketing_time}</td>
                                                <td class="hover-bg">
                                        ...
                                        <tr>
                                            <td class="event-time">{items.node.acf.technology_time}</td>
                                                <td class="hover-bg">
                                                    <h5>{items.node.acf.techno_filed.tech_name}</h5>
                                                    <p><span>By</span> {items.node.acf.techno_filed.tech_time}</p>
                                                </td>
                                        </tr>
                                        <tr>
                                            <td class="event-time">{items.node.acf.talk_time}</td>
                                                <td class="hover-bg">
