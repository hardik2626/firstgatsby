            ...
            <div className="col-lg-12">
                <div className="schedule-table-tab">
                    <ul className="nav nav-tabs" role="tablist">
                        {props.allWordpressWpSchedule.edges.map((itemmenu) => (
                                    
                            <li className="nav-item" activeclassName='active' key={itemmenu.node.categories.slug} data-toggle="tab" href={itemmenu.node.categories.slug} role="tab">
                                <Link to={`/${itemmenu.node.categories.slug}`} className="nav-link active" data-toggle="tab" href="#tabs-1" role="tab">{itemmenu.node.categories.name}</Link>
                            </li>
                        ))}
                            ...
                            <div className="schedule-table-content">
                                <table>
                                    ...
                                    {props.allWordpressWpSchedule.edges.map((ddd) => (
                                        <tr>
                                            {/* <td className="event-time">{ddd.node.event_schedule.schedule_time}</td> */}
                                            {/* <td className="break hover-bg"><h5>{ddd.node.event_schedule.schedule_time}</h5></td> */}
                                        </tr>
                                    ))}
                                        {/* <tr>
