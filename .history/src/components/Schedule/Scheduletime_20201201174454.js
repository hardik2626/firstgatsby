                ...
                <div className="schedule-table-tab">
                    <ul className="nav nav-tabs" role="tablist">
                        {props.allWordpressWpSchedule.edges.map((itemmenu) => (
                            <li className="nav-item" key={itemmenu.node.categories.slug}>
                                <Link to={`/${itemmenu.node.categories.slug}`} className="nav-link" activeclassName='active' data-toggle="tab" href="#tabs-1" role="tab">{itemmenu.node.categories.name}</Link>
                            </li>
                        ))}
