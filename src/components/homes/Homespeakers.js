    ...
    <div className="member-item set-bg" style={{backgroundImage: `url(${speak.node.featured_media.localFile.url})`}}>
        <div className="mi-social">
            <div className="mi-social-inner bg-gradient">
                ...
                <a href={speak.node.acf.speaker_insta_url}><i className="fa fa-instagram"></i></a>
                <a href={speak.node.acf.speaker_linkedin_url}><i className="fa fa-twitter"></i></a>
                <a href={speak.node.acf.speaker_twitter_url}><i className="fa fa-linkedin"></i></a>
            </div>
        </div>
